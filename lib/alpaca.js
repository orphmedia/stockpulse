...
export async function getYahooQuotes(symbols) {
  try {
    ...
    const res = await fetch(
      `https://query1.finance.yahoo.com/v7/finance/quote?symbols=${symbolStr}&fields=regularMarketPrice,regularMarketChange,regularMarketChangePercent,shortName,regularMarketPreviousClose,regularMarketVolume,regularMarketDayHigh,regularMarketDayLow,regularMarketOpen,trailingAnnualDividendRate,trailingAnnualDividendYield,dividendDate,epsTrailingTwelveMonths,trailingPE,marketCap,fiftyTwoWeekHigh,fiftyTwoWeekLow,averageAnalystRating,targetMeanPrice,targetHighPrice,targetLowPrice,numberOfAnalystOpinions,recommendationMean,recommendationKey`,
